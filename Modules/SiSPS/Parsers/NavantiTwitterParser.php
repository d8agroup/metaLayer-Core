...
class NavantiTwitterParser implements IParser {
    /**
    ...
    private function GetForTwitterAccount($channel) 
    {
        ...
        $return = $this->GetForTwitterSearch($channel);
        ...
        /*
         * For the openSEAS implementation this function uses the search implementation and the from:[ACCOUNT] Twitter
         * query syntax to follow users tweets
